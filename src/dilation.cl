...
__kernel void dilate(__global const float *d_input, __global float *d_output, __global int *struct_kernel, int sizeX, int sizeY) {
...
__kernel void dilate_image(__read_only image2d_t d_input, __read_write image2d_t d_output, __global int *struct_kernel, int sizeX, int sizeY) {
    size_t countX = get_global_size(0);
    size_t countY = get_global_size(1);
    size_t i = get_global_id(0);
    size_t j = get_global_id(1);
