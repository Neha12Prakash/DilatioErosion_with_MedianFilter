...
public:
    ...
    lear short3
    xxx, yxx, zxx, xyx, yyx, zyx, xzx, yzx, zzx, xxy, yxy, zxy, xyy, yyy, zyy, xzy, yzy, zzy, xxz, yxz, zxz, xyz, yyz, zyz, xzz, yzz,
    zzz;
};
...
event_t
async_work_group_strided_copy(char *dst, const char *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(char2 *dst, const char2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(char2 *dst, const char2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(char3 *dst, const char3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(char3 *dst, const char3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(char4 *dst, const char4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(char4 *dst, const char4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(char8 *dst, const char8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(char8 *dst, const char8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(char16 *dst, const char16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(char16 *dst, const char16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar *dst, const uchar *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar *dst, const uchar *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar2 *dst, const uchar2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar2 *dst, const uchar2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar3 *dst, const uchar3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar3 *dst, const uchar3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar4 *dst, const uchar4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar4 *dst, const uchar4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar8 *dst, const uchar8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar8 *dst, const uchar8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uchar16 *dst, const uchar16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uchar16 *dst, const uchar16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short *dst, const short *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short *dst, const short *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short2 *dst, const short2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short2 *dst, const short2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short3 *dst, const short3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short3 *dst, const short3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short4 *dst, const short4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short4 *dst, const short4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short8 *dst, const short8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short8 *dst, const short8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(short16 *dst, const short16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(short16 *dst, const short16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort *dst, const ushort *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ushort *dst, const ushort *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort2 *dst, const ushort2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ushort2 *dst, const ushort2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort3 *dst, const ushort3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ushort3 *dst, const ushort3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort4 *dst, const ushort4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ushort4 *dst, const ushort4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort8 *dst, const ushort8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ushort8 *dst, const ushort8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ushort16 *dst, const ushort16 *src, size_t num_gentypes, event_t event);

event_t async_work_group_strided_copy(ushort16 *dst, const ushort16 *src, size_t num_gentypes, size_t src_stride,
                                      event_t event);
...
event_t
async_work_group_strided_copy(int2 *dst, const int2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(int3 *dst, const int3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(int3 *dst, const int3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(int4 *dst, const int4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(int4 *dst, const int4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(int8 *dst, const int8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(int8 *dst, const int8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(int16 *dst, const int16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(int16 *dst, const int16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint *dst, const uint *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint *dst, const uint *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint2 *dst, const uint2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint2 *dst, const uint2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint3 *dst, const uint3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint3 *dst, const uint3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint4 *dst, const uint4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint4 *dst, const uint4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint8 *dst, const uint8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint8 *dst, const uint8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(uint16 *dst, const uint16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(uint16 *dst, const uint16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long *dst, const long *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long *dst, const long *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long2 *dst, const long2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long2 *dst, const long2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long3 *dst, const long3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long3 *dst, const long3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long4 *dst, const long4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long4 *dst, const long4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long8 *dst, const long8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long8 *dst, const long8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(long16 *dst, const long16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(long16 *dst, const long16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong *dst, const ulong *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong *dst, const ulong *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong2 *dst, const ulong2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong2 *dst, const ulong2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong3 *dst, const ulong3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong3 *dst, const ulong3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong4 *dst, const ulong4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong4 *dst, const ulong4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong8 *dst, const ulong8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong8 *dst, const ulong8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(ulong16 *dst, const ulong16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(ulong16 *dst, const ulong16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float *dst, const float *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float *dst, const float *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float2 *dst, const float2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float2 *dst, const float2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float3 *dst, const float3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float3 *dst, const float3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float4 *dst, const float4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float4 *dst, const float4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float8 *dst, const float8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float8 *dst, const float8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(float16 *dst, const float16 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(float16 *dst, const float16 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double *dst, const double *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(double *dst, const double *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double2 *dst, const double2 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(double2 *dst, const double2 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double3 *dst, const double3 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(double3 *dst, const double3 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double4 *dst, const double4 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(double4 *dst, const double4 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double8 *dst, const double8 *src, size_t num_gentypes, event_t event);

event_t
async_work_group_strided_copy(double8 *dst, const double8 *src, size_t num_gentypes, size_t src_stride, event_t event);

event_t async_work_group_copy(double16 *dst, const double16 *src, size_t num_gentypes, event_t event);

event_t async_work_group_strided_copy(double16 *dst, const double16 *src, size_t num_gentypes, size_t src_stride,
                                      event_t event);
